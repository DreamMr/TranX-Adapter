...
class TunerArguments:
    ...
    def _init_multimodal_full(self):
        ...
        if self.freeze_aligner_expert:
            self.freeze_parameters += model_arch.aligner_expert
        else:
            self.trainable_parameters += model_arch.aligner_expert
        if self.freeze_vit_expert:
            self.freeze_parameters += model_arch.vision_tower_expert
        else:
            self.trainable_parameters += model_arch.vision_tower_expert
