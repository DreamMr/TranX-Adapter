...
def get_model_tokenizer_llava_next_aigc_detection(model_dir, modek_info: ModelInfo, model_kwargs: Dict[str, Any], load_model: bool=True, **kwargs):
...
register_model(
    ModelMeta(
        # MLLMModelType.llava1_6_vicuna_hf,
        "llava1_6_vicuna_hf_npr_expert_projector",
        [
            ModelGroup([
                Model('llava_aigc_detection_npr', 'llava_aigc_detection_npr'),
            ], ),
        ],
        TemplateType.llava1_6_vicuna_hf,
        get_model_tokenizer_llava_next_aigc_detection,
        architectures=['CustomLlavaNextForConditionalGeneration'],
        model_arch=ModelArch.llava_npr_hf,
        requires=['transformers>=4.39'],
        tags=['vision'],
        is_multimodal=True
    ))
...
register_model(
    ModelMeta(
        # MLLMModelType.llava1_6_mistral_hf,
        "llava1_6_mistral_hf_npr_expert_projector",
        [
            ModelGroup([
                Model('llava_aigc_detection_npr', 'llava_aigc_detection_npr'),
            ], ),
