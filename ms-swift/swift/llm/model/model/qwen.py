...
def get_model_tokenizer_qwen3vl_aigc_detection(model_dir, modek_info: ModelInfo, model_kwargs: Dict[str, Any], load_model: bool=True, **kwargs):
    
    from qwen3vlnpr.modeling_qwen3vlnpr import CustomQwen3VLForConditionalGeneration
    from qwen3vlnpr.config_qwen3vlnpr import Qwen3VLWithVisionExpertConfig, ResnetConfig
    ...
    processor = CustomQwen3VLProcessor.from_pretrained(model_dir)
    return model, processor

register_model(
    ModelMeta( 
        "qwen3_vl_aigc_detection_npr",
        [
            ModelGroup([
                Model('qwen3_vl_aigc_detection_npr', 'qwen3_vl_aigc_detection_npr')
            ],),
        ],
        TemplateType.qwen3_vl,
        get_model_tokenizer_qwen3vl_aigc_detection,
        model_arch=ModelArch.qwen3_vl_npr,
        is_multimodal=True,
        architectures=['CustomQwen3VLForConditionalGeneration'],
